      ...
      <div className='primary-container'>
        <div className='flex justify-between items-center mb-16'>
          ...
          <div className='max-w-[34rem]'>
            <h2 className='text-4xl md:text-5xl font-bold'>The best startup companies build on here</h2>
          </div>
              ...
              customerData.map((customer) => (
                <div key={customer.id} className='w-full shrink-0 relative'>
                  <div className='relative aspect-video overflow-hidden rounded-lg'>
                    <video src={customer.video} poster={customer.poster} className='w-full h-full object-cover'
                    data-customer={customer.id} autoPlay muted playsInline loop ></video>
